...
return (
<section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-10 lg:px-16 bg-[#070A12]" id="Blog">
<div className="max-w-6xl mx-auto">
<div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-10 mb-10 sm:mb-14">
