...
import { FaFacebookF, FaPinterestP, FaYoutube, FaTimes } from "react-icons/fa";
...
export default function Team({
  ...
  return (
    <section className="bg-[#070A12] py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-10 lg:px-16">
      <div
        className={
          showAll
